...
class InterfazTkinter:
    def __init__(self, master):
        ...
        self.entry_nombre2.grid(row=1, column=1, padx=10, pady=10)

        self.label_sueldo1 = ttk.Label(self.master, text="Sueldo de la persona 1:")
        self.label_sueldo1.grid(row=2, column=0, padx=10, pady=10)

        self.entry_sueldo1 = ttk.Entry(self.master)
        self.entry_sueldo1.grid(row=2, column=1, padx=10, pady=10)
        ...
        self.calcular_button = ttk.Button(self.master, text="Calcular", command=self.calcular_resultado)
        self.calcular_button.grid(row=4, column=0, columnspan=2, pady=10)

        self.textbox = tk.Text(self.master, height=10, width=40)
